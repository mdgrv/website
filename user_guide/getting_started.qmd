...
Seqera Platform, previously known as Nextflow Tower, is a web-based user interface for running and monitoring Nextflow pipelines. If you are planning on using Seqera Platform, a [compute environment](https://docs.seqera.io/platform/23.3.0/compute-envs/overview) will need to be set up.